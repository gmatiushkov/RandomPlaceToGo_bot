...
btn_large_green_place = InlineKeyboardButton("Больше растительности 🌲", callback_data="large_green_place_type")  # Новая кнопка
btn_water_place = InlineKeyboardButton("У воды 🌊", callback_data="water_place_type")
btn_change_radius = InlineKeyboardButton("Изменить радиус", callback_data="change_radius")
btn_change_location = InlineKeyboardButton("Изменить начальную точку", callback_data="change_location")
btn_back = InlineKeyboardButton("⬅️ Назад", callback_data="back_to_menu")
place_type_menu.add(btn_random_place, btn_green_place, btn_large_green_place, btn_water_place, btn_change_radius, btn_change_location, btn_back)
